...
namespace HierarchicalTenancyTest.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly HierarchicalTenancyTestDbContext _context;

        public HostRoleAndUserCreator(HierarchicalTenancyTestDbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            var permissions = PermissionFinder
                .GetAllPermissions(new HierarchicalTenancyTestAuthorizationProvider())
